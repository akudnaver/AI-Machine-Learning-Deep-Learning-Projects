# importing the libraries required to decode the HTML page and pull a table from a Web Page.
# This code expects users to have fair amount of knoledge on how to read throuhg the HTML body,tags,classes. You can refer
# the below links to develope an understanding of web page and for some basic foundation on Python Beautiful Soup functionality. 
...
# Here is a quick definition to iterate over each rows - 'tr' under a table body of your choice. We are basically
# reading through the table rows 
...
# Here we are only interested in the website under variable URL , i will try to make generic in the my next project. 
# You can use the webpage to play with the Beautiful soup function.
...
while True:
    ...
    # In the below code we will add table to our empty data frame, the end result will have our table in the CSV format
